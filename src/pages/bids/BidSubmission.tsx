...
const BidSubmission = () => {
  ...
  const tender = {
    ...
    description:
      "Comprehensive HVAC maintenance services for a portfolio of commercial buildings including preventive maintenance, emergency repairs, and system optimization.",
    requirements: [
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    {tender.requirements.map((req, index) => (
                      <li
                        key={index}
                        className="text-sm text-purple-200 flex items-start"
                      >
                  ...
                  <div className="flex justify-between">
                    {completionSteps.map((step, index) => (
                      <div key={index} className="flex items-center">
                        ...
                        <span
                          className={`text-xs ${step.completed ? "text-green-300" : "text-purple-200"}`}
                        >
                          {step.name}
                        </span>
                      </div>
                ...
                <TabsContent value="technical">
                  <Card className="glass-card border-purple-500/20">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div>
                        <Label htmlFor="equipment" className="text-purple-200">
                          Equipment & Tools
                        </Label>
                        <Textarea
                          id="equipment"
                    ...
                    <CardContent className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="border-2 border-dashed border-purple-500/30 rounded-lg p-6 text-center hover:border-purple-400/50 transition-colors">
                          ...
                          <Button className="mt-3 glass-button" size="sm">
                            Choose File
                          </Button>
                        </div>
                        ...
                        <div className="border-2 border-dashed border-purple-500/30 rounded-lg p-6 text-center hover:border-purple-400/50 transition-colors">
                          ...
                          <p className="text-purple-200 text-sm">
                            Upload detailed technical docs
                          </p>
                          <Button className="mt-3 glass-button" size="sm">
                            Choose File
                          </Button>
