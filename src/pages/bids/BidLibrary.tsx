...
const BidLibrary = () => {
  ...
  const templates = [
    {
      ...
      description:
        "Comprehensive template for HVAC system maintenance contracts including preventive care and emergency response.",
      usageCount: 12,
      successRate: 85,
      avgBidAmount: "$45,000",
      lastUsed: "2024-01-10",
    ...
    },
    {
      ...
      description:
        "Template for security service proposals including patrol schedules, monitoring systems, and emergency protocols.",
      usageCount: 8,
      successRate: 75,
      avgBidAmount: "$65,000",
      lastUsed: "2024-01-08",
    ...
    },
    {
      ...
      description:
        "Template for landscaping and groundskeeping services including seasonal maintenance and aesthetic improvements.",
      usageCount: 15,
      successRate: 90,
      avgBidAmount: "$28,000",
      lastUsed: "2024-01-05",
    ...
    },
    {
      ...
      category: "Technology",
      description:
        "Template for IT infrastructure projects including network setup, security implementation, and ongoing support.",
      usageCount: 6,
      successRate: 67,
  ...
  const filteredPastBids = pastBids.filter(
    (bid) =>
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-purple-200">
                Access templates, past bids, and successful proposals
              </p>
            </div>
            ...
            <TabsContent value="templates">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredTemplates.map((template) => (
                  <Card
                    key={template.id}
                    className="glass-card border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 transform hover:scale-105"
                  >
                    <CardHeader>
                        ...
                        <div className="flex flex-wrap gap-1 mb-4">
                          {template.tags.map((tag, index) => (
                            <Badge
                              key={index}
                              variant="outline"
                              className="text-xs bg-purple-500/10 border-purple-500/30 text-purple-200"
                            >
                              {tag}
                            </Badge>
                          ))}
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          ...
                          <p className="text-purple-200 text-sm">
                            Bid ID: {bid.id} • Category: {bid.category}
                          </p>
                        </div>
