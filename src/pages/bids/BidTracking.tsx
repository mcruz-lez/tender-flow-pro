...
const BidTracking = () => {
  ...
  const bids = [
    {
      ...
      progress: 65,
      feedback:
        "Technical specifications under review. Financial evaluation pending.",
    ...
    },
    {
      ...
      progress: 100,
      feedback:
        "Congratulations! Your bid has been selected. Contract signing scheduled.",
    ...
    },
    {
      ...
      progress: 100,
      feedback:
        "Thank you for your submission. While competitive, another bid was selected based on technical expertise.",
  ...
  const filteredBids = bids.filter((bid) => {
    ...
    if (activeTab === "active")
      return (
        matchesSearch && ["Submitted", "Under Review"].includes(bid.status)
      );
    if (activeTab === "awarded")
      return matchesSearch && bid.status === "Awarded";
    if (activeTab === "rejected")
      return matchesSearch && bid.status === "Rejected";
        ...
        <div className="p-6">
          ...
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link to="/bids" className="text-purple-300 hover:text-white">
                    Bid Management
                  </Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              ...
              <p className="text-purple-200">
                Monitor the status and progress of your submitted bids
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Track how many bids are at each stage
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Smart recommendations for your bid tracking
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="list-disc list-inside space-y-2 text-gray-200">
                  <li>
                    Automate reminders for upcoming deadlines and reviews.
                  </li>
                  <li>
                    Use AI to predict bottlenecks in the evaluation process.
                  </li>
                  <li>
                    Visualize bid progress to optimize resource allocation.
                  </li>
                  <li>
                    Integrate with analytics for deeper performance insights.
                  </li>
                </ul>
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <CardDescription className="text-purple-200">
                            Bid ID: {bid.id} • Tender ID: {bid.tenderId} •
                        ...
                        <div className="lg:col-span-2">
                          <div className="mb-4">
                            ...
                            <p className="text-sm text-purple-200">
                              Current Stage: {bid.evaluationStage}
                            </p>
                          </div>
              ...
              <CardContent className="p-6 text-center">
                ...
                <p className="text-2xl font-bold text-purple-400">
                  {Math.round(
                    (bids.filter((b) => b.status === "Awarded").length /
                      bids.filter((b) =>
                        ["Awarded", "Rejected"].includes(b.status),
                      ).length) *
                      100,
                  ) || 0}
                  %
