          ...
          <Card className="glass-card border-blue-500/20 mt-4">
            ...
            <CardContent>
              <div className="flex flex-col items-center">
                ...
                <p className="mt-4 text-sm text-blue-200">Coming soon: Interactive cost dashboard</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card className="glass-card border-green-500/20 mt-4">
            ...
            <CardContent>
              <div className="flex flex-col items-center">
                ...
                <p className="mt-4 text-sm text-green-200">Coming soon: Interactive cost trends charts</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
