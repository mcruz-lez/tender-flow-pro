  ...
  const qaData = [
    {
      id: "QA001",
      question:
        "What is the required emergency response time for HVAC maintenance?",
      answer:
        "Emergency response time must be within 4 hours of notification, 24/7 including weekends and holidays.",
    ...
    },
    {
      id: "QA002",
      question:
        "Are there any specific insurance requirements for security personnel?",
      answer:
        "All security personnel must have comprehensive liability insurance with minimum coverage of $2M.",
    ...
    },
    {
      id: "QA003",
      question:
        "What are the environmental compliance requirements for cleaning products?",
      answer: "",
    ...
    },
    {
      id: "QA004",
      question:
        "Can we propose alternative materials that meet the same specifications?",
      answer:
        "Alternative materials may be proposed if they meet or exceed the specified performance criteria. Please provide detailed technical specifications and certifications.",
          ...
          <TabsContent value="manage">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Review and respond to tender questions
                </CardDescription>
                    ...
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <CardDescription>
                            {qa.tender} • {qa.category} • Submitted by{" "}
                            {qa.submittedBy} on {qa.submittedDate}
                          </CardDescription>
                        </div>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          <Button
                            variant="outline"
                            onClick={() => handleSaveAsDraft(qa.id)}
                          >
                            Save as Draft
                          </Button>
          ...
          <TabsContent value="published">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Questions and answers visible to all bidders
                </CardDescription>
              </CardHeader>
              <CardContent>
