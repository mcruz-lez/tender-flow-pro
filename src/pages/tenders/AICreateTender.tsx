...
const AICreateTender = () => {
  const quickActions = [
    { label: "Traditional Create", href: "/tenders/create", icon: FileText, variant: "outline" as const },
    { label: "Browse Templates", href: "/tenders/templates", icon: FileText, variant: "outline" as const },
    { label: "View Vendors", href: "/vendors", icon: Users, variant: "outline" as const }
  ];
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Describe your project requirements and let AI generate a comprehensive tender document
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Smart suggestions based on your input</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="font-medium text-blue-900">Smart Vendor Matching</span>
                  </div>
                  <p className="text-sm text-blue-700">
                    Found 12 qualified vendors in your area with HVAC expertise and positive performance ratings.
                  </p>
                  <Button asChild size="sm" className="mt-2" variant="outline">
                    <Link to="/vendors?category=hvac">View Matching Vendors</Link>
                  </Button>
                </div>
                ...
                <div className="p-4 bg-green-50 rounded-lg">
                  ...
                  <p className="text-sm text-green-700">
                    Similar projects averaged $75,000. Consider splitting into preventive maintenance and emergency services for better cost control.
                  </p>
                  <Button asChild size="sm" className="mt-2" variant="outline">
                ...
                <div className="p-4 bg-orange-50 rounded-lg">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="font-medium text-orange-900">Timeline Suggestions</span>
                  </div>
                  <p className="text-sm text-orange-700">
                    Consider 4-week bid submission period and 2-week evaluation phase for optimal vendor participation.
                  </p>
                  <Button asChild size="sm" className="mt-2" variant="outline">
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-3">
              {[
                { name: "Smart Requirements", description: "Auto-generate technical specs", available: true },
                { name: "Compliance Check", description: "Verify regulatory requirements", available: true },
                { name: "Risk Assessment", description: "Identify potential project risks", available: true },
                { name: "Vendor Matching", description: "Find qualified service providers", available: true },
                { name: "Cost Estimation", description: "Predict market pricing", available: true },
                { name: "Timeline Optimization", description: "Suggest optimal schedules", available: false }
              ].map((feature, index) => (
