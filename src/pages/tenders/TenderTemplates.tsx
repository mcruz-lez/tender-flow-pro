  ...
  const templates = [
    {
      ...
      description:
        "Comprehensive template for HVAC system maintenance and repair contracts",
      lastUsed: "2023-12-10",
      usage: 45,
      rating: 4.8,
      featured: true,
    ...
    },
    {
      ...
      category: "security",
      description:
        "Complete security services template for commercial buildings",
      lastUsed: "2023-12-08",
      usage: 32,
      rating: 4.7,
      featured: true,
    ...
    },
    {
      ...
      description:
        "Template for electrical infrastructure upgrades and installations",
      lastUsed: "2023-12-05",
      usage: 28,
      rating: 4.6,
      featured: false,
    ...
    },
    {
      ...
      category: "cleaning",
      description:
        "Standard template for commercial cleaning and janitorial services",
      lastUsed: "2023-12-03",
      usage: 67,
      rating: 4.9,
      featured: true,
    ...
    },
    {
      ...
      category: "maintenance",
      description:
        "Comprehensive landscaping and groundskeeping services template",
      lastUsed: "2023-11-28",
      usage: 23,
      rating: 4.5,
      featured: false,
    ...
    },
    {
      ...
      category: "technology",
      description:
        "Technology services and IT infrastructure management template",
      lastUsed: "2023-11-25",
      usage: 19,
      rating: 4.4,
      featured: false,
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-white/70 mt-2">
                Create tenders faster with pre-built templates
              </p>
            </div>
                    ...
                    .map((template) => (
                      ...
                      >
                        <CardHeader className="pb-3">
                          ...
                          <CardTitle className="text-xl font-semibold tracking-tight line-clamp-2 group-hover:text-indigo-200 transition-colors">
                            {template.name}
                          </CardTitle>
                        ...
                        <CardContent className="space-y-4">
                          ...
                          <div className="flex justify-between items-center">
                            <Badge
                              className={`text-xs font-semibold ${getComplexityColor(template.complexity)} inline-flex items-center gap-2`}
                            >
                              {template.complexity}
                            </Badge>
                ...
                <CardContent>
                  <div className="text-center py-8">
                    ...
                    <p className="text-white/40 text-sm mt-2">
                      Create your first template or customize an existing one
                    </p>
