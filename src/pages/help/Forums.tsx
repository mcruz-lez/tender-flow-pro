...
const Forums = () => {
  ...
  const handleNewTopic = (e: React.FormEvent) => {
    ...
    if (newTopic && newAuthor) {
      setTopics([
        { title: newTopic, author: newAuthor, replies: 0 },
        ...topics,
      ]);
      setNewTopic("");
      setNewAuthor("");
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card>
          <CardHeader>
            <CardTitle>Forum Activity Trend</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div className="flex justify-end gap-2 mb-8">
        <Button asChild size="sm" variant="outline">
          <a href="/help/user-groups">User Groups</a>
        </Button>
        <Button asChild size="sm" variant="outline">
          ...
          <Card key={idx}>
            <CardContent className="flex flex-col md:flex-row md:items-center md:justify-between p-4">
              <div>
                ...
                <div className="text-gray-500 text-sm">By {topic.author}</div>
              </div>
