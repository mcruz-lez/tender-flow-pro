      ...
      setFaqsList([
        {
          ...
          answer:
            "Thank you for your question! Our support team will respond soon.",
        },
        ...faqsList,
      ]);
      setSubmitted(true);
    ...
    >
      <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="font-medium text-blue-900">
          ...
          <a href="mailto:support@tendprocure.com" className="underline">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card>
          <CardHeader>
            <CardTitle>FAQ Usage Trend</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div className="flex justify-end gap-2 mb-8">
        ...
        <Button asChild size="sm" variant="outline">
          <a href="/help/technical-support">Support</a>
        </Button>
        <Button asChild size="sm" variant="outline">
          <a href="/docs">Docs</a>
        </Button>
      ...
      <div className="mb-8">
        ...
        <form
          className="flex flex-col md:flex-row gap-4 items-start md:items-end mb-4"
