...
const stories = [
	{
		...
		summary: "Acme Corp reduced procurement cycle time by 40% using TendProcure's automation tools.",
		author: "Procurement Lead, Acme Corp",
	},
	{
		title: "Vendor Collaboration Success",
		summary: "Improved vendor relationships and compliance tracking for a global manufacturer.",
		author: "COO, Global Manufacturing Inc.",
	},
	{
		title: "Seamless Document Management",
		summary: "A property management firm achieved full digital transformation with secure document workflows.",
