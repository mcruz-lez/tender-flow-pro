...
const EvaluationPanel = () => {
  ...
  const quickActions = [
    ...
    { label: "Generate Report", href: "#", icon: FileText, variant: "outline" as const },
    { label: "Send to Approval", href: "#", icon: Send, variant: "outline" as const }
  ];
  ...
  const evaluationCriteria = [
    { id: "technical", name: "Technical Capability", weight: 30, maxScore: 100 },
    { id: "price", name: "Price Competitiveness", weight: 25, maxScore: 100 },
    { id: "experience", name: "Experience & Track Record", weight: 20, maxScore: 100 },
    { id: "resources", name: "Resource Availability", weight: 15, maxScore: 100 },
  ...
  const bids: BidWithScores[] = [
    {
      ...
      overallScore: 0,
      evaluatorScores: {
        evaluator1: { technical: 85, price: 90, experience: 80, resources: 85, compliance: 95 },
        evaluator2: { technical: 80, price: 88, experience: 85, resources: 80, compliance: 90 }
      }
    },
    {
      id: "2",
      ...
      overallScore: 0,
      evaluatorScores: {
        evaluator1: { technical: 90, price: 75, experience: 95, resources: 90, compliance: 85 },
        evaluator2: { technical: 88, price: 78, experience: 90, resources: 85, compliance: 88 }
      }
    },
    {
      id: "3",
      ...
      overallScore: 0,
      evaluatorScores: {
        evaluator1: { technical: 95, price: 95, experience: 85, resources: 80, compliance: 90 },
        evaluator2: { technical: 92, price: 92, experience: 88, resources: 85, compliance: 88 }
      }
    }
  ];

  const evaluators = [
    { id: "evaluator1", name: "John Smith", role: "Technical Manager", status: "Active" },
    { id: "evaluator2", name: "Sarah Wilson", role: "Procurement Lead", status: "Active" },
    { id: "evaluator3", name: "Mike Johnson", role: "Finance Manager", status: "Pending" }
  ];
  ...
  const discussionComments = [
    {
      ...
      comment: "Elite Mechanical shows strong technical capability but I'm concerned about their resource availability for this scale of project.",
      bidId: "3"
    },
    {
      id: "2", 
      ...
      comment: "Climate Control Solutions has competitive pricing and excellent compliance records. Their experience with similar projects is impressive.",
      bidId: "1"
    }
  ];
  ...
  const handleScoreChange = (bidId: string, criteriaId: string, score: number) => {
    setScores(prev => ({
      ...prev,
      [bidId]: {
        ...prev[bidId],
          ...
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardDescription>ID: {tender.id} • {tender.category}</CardDescription>
              </div>
              ...
              {bids.map((bid) => (
                <div
                  ...
                  className={`p-3 rounded-lg border cursor-pointer transition-colors ${
                    selectedBid === bid.id ? 'border-blue-500 bg-blue-50' : 'hover:bg-gray-50'
                  }`}
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="text-xs">Score: {calculateWeightedScore(bid)}/100</div>
                    <Progress value={calculateWeightedScore(bid)} className="w-12 h-2" />
                  </div>
                </div>
              ))}
            </CardContent>
                  ...
                  <CardContent className="space-y-6">
                      ...
                      <div key={criteria.id} className="space-y-2">
                        ...
                        <div className="flex items-center gap-4">
                          <Input
                            ...
                            onChange={(e) => handleScoreChange(selectedBid, criteria.id, parseInt(e.target.value) || 0)}
                            className="w-24"
                          />
                          <span className="text-sm text-gray-500">/ {criteria.maxScore}</span>
                          <Progress 
                            value={(scores[selectedBid]?.[criteria.id] || 0) / criteria.maxScore * 100} 
                            className="flex-1"
                          />
                        </div>
                      </div>
                    ...
                    <div className="pt-4 border-t">
                      <Textarea
                        ...
                        onChange={(e) => setComments({...comments, [selectedBid]: e.target.value})}
                        rows={3}
                      />
                    </div>
              ...
              <TabsContent value="comparison">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Compare all bids side by side</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Table>
                      <TableHeader>
              ...
              <TabsContent value="discussion">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Collaborate with other evaluators</CardDescription>
                  </CardHeader>
                      ...
                      {discussionComments.map(comment => (
                        <div key={comment.id} className="border rounded-lg p-4">
                          <div className="flex justify-between items-start mb-2">
                            <div className="font-medium">{comment.evaluator}</div>
                            <div className="text-sm text-gray-500">{comment.timestamp}</div>
                          </div>
                          <p className="text-gray-700 mb-2">{comment.comment}</p>
                          <div className="flex items-center gap-2">
                            <Badge variant="outline">
                              Bid: {bids.find(b => b.id === comment.bidId)?.vendor}
                            </Badge>
              ...
              <TabsContent value="documents">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Review submitted documents for each bid</CardDescription>
                  </CardHeader>
                  <CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-600">2 of 3 evaluators have completed their assessment</p>
              </div>
              <div className="flex gap-2">
