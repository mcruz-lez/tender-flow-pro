...
const PageTemplate = ({ title, description, children, quickActions, relatedPages }: PageTemplateProps) => {
  ...
  const getContextualActions = (): QuickAction[] => {
    ...
    if (path.includes('/tenders')) {
      return [
        ...
        { label: "Browse Vendors", href: "/vendors", icon: ExternalLink, variant: "outline" }
      ];
    }
    ...
    if (path.includes('/bids')) {
      return [
        ...
        { label: "View Tenders", href: "/tenders", icon: ExternalLink, variant: "outline" }
      ];
    }
    ...
    if (path.includes('/vendors')) {
      return [
        ...
        { label: "Prequalification", href: "/vendors/prequalification", icon: Filter },
        { label: "View Opportunities", href: "/opportunities", icon: ExternalLink, variant: "outline" }
      ];
    }
    ...
    if (path.includes('/contracts')) {
      return [
        ...
        { label: "Performance", href: "/contracts/performance", icon: Construction },
        { label: "View Tenders", href: "/tenders", icon: ExternalLink, variant: "outline" }
      ];
    }
    ...
    if (path.includes('/properties')) {
      return [
        ...
        { label: "Maintenance", href: "/properties/maintenance", icon: Construction },
        { label: "Service Categories", href: "/properties/services", icon: ExternalLink, variant: "outline" }
      ];
    }
        ...
        <div className="p-6">
          ...
          {contextualRelatedPages.length > 0 && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h3 className="text-sm font-medium text-blue-900 mb-2">Related Sections</h3>
